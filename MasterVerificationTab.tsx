    ...
    return {
      ...
      business: {
        businessName: masterVerification?.business?.businessName || {
          ...
          status: 'Verified',
          notes: 'Active with Secretary of State',
        },
        ...
        businessStartDate: masterVerification?.business?.businessStartDate || {
          ...
          status: 'Verified',
          notes: 'Over 5 years in business',
        },
        ...
        industry: masterVerification?.business?.industry || {
          ...
          status: 'Verified',
          notes: 'Standard tier-1 industry',
        },
      ...
      employmentVerification: {
        sectionStatus: masterVerification?.employmentVerification?.sectionStatus || 'Verified',
        currentlyWorking: masterVerification?.employmentVerification?.currentlyWorking || {
          asApplied: 'Yes',
          verified: 'Yes',
          status: 'Verified',
          notes: 'Currently working full-time',
        ...
        selfEmployed: masterVerification?.employmentVerification?.selfEmployed || {
          ...
          verified: 'Yes',
          status: 'Verified',
          notes: 'Sole member/owner of business LLC',
        ...
        employedByAnotherCompany: masterVerification?.employmentVerification?.employedByAnotherCompany || {
          ...
          verified: 'Yes',
          status: 'Verified',
          notes: 'W-2 employee in addition to owning business',
        ...
        employerName: masterVerification?.employmentVerification?.employerName || {
          ...
          status: 'Verified',
          notes: 'Active hospital network employer',
        ...
        jobOccupation: masterVerification?.employmentVerification?.jobOccupation || {
          ...
          status: 'Verified',
          notes: 'Clinical and operational logistics',
        ...
        jobDescription: masterVerification?.employmentVerification?.jobDescription || {
          ...
          status: 'Verified',
          notes: 'Confirmed responsibilities with employer records',
        ...
        employmentStartDate: masterVerification?.employmentVerification?.employmentStartDate || {
          ...
          verified: '2020-03-01',
          status: 'Verified',
          notes: '4.5+ years of continuous service',
        ...
        employmentTypeStatus: masterVerification?.employmentVerification?.employmentTypeStatus || {
          ...
          verified: 'Full-Time',
          status: 'Verified',
          notes: 'Exempt salaried full-time employee',
        ...
        annualSalary: masterVerification?.employmentVerification?.annualSalary || {
          ...
          verified: '$145,000',
          status: 'Verified',
          notes: 'Base salary verified via pay stub',
        ...
        monthlySalary: masterVerification?.employmentVerification?.monthlySalary || {
          ...
          verified: '$12,083',
          status: 'Verified',
          notes: 'Calculated from annual salary',
        ...
        annualEmploymentIncome: masterVerification?.employmentVerification?.annualEmploymentIncome || {
          ...
          verified: '$160,000',
          status: 'Verified',
          notes: 'Includes $15,000 annual performance bonus',
        ...
        monthlyEmploymentIncome: masterVerification?.employmentVerification?.monthlyEmploymentIncome || {
          ...
          verified: '$13,333',
          status: 'Verified',
          notes: 'Includes bonus distribution',
        ...
        otherMonthlyIncome: masterVerification?.employmentVerification?.otherMonthlyIncome || {
          ...
          verified: '$2,500',
          status: 'Verified',
          notes: 'Rental property cashflow',
        ...
        otherIncomeSource: masterVerification?.employmentVerification?.otherIncomeSource || {
          ...
          status: 'Verified',
          notes: 'Schedule E on tax returns',
        ...
        receivesPayStubs: masterVerification?.employmentVerification?.receivesPayStubs || {
          ...
          verified: 'Yes',
          status: 'Verified',
          notes: 'Bi-weekly electronic pay stubs',
        ...
        paidThroughPayroll: masterVerification?.employmentVerification?.paidThroughPayroll || {
          ...
          verified: 'Yes',
          status: 'Verified',
          notes: 'Automated direct deposit via ADP',
        ...
        payStubReceived: masterVerification?.employmentVerification?.payStubReceived || {
          ...
          verified: 'Yes',
          status: 'Verified',
          notes: 'PDF uploaded to Document Vault',
        ...
        payStubReviewed: masterVerification?.employmentVerification?.payStubReviewed || {
          ...
          verified: 'Yes',
          status: 'Verified',
          notes: 'Reviewed and corroborated by underwriter',
          script: 'Has the pay stub been reviewed for accuracy?',
        },
        employmentIncomeNotes: masterVerification?.employmentVerification?.employmentIncomeNotes || 'Client maintains a stable high-compensation W2 role in addition to owning 100% of the operating business. Strong overall repayment capacity.',
        redFlags: masterVerification?.employmentVerification?.redFlags || 'None detected. Employment is stable (4.5+ yrs) and corroborated with recent ADP pay stubs.',
    ...
    return (
      <div key={fieldKey} className="p-3.5 bg-[#070d18] border border-blue-900/40 rounded-xl space-y-2">
        <div className="flex items-center justify-between">
          ...
          <select
            value={safeFieldData.status || 'Matches Application'}
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-blue-900/30 pb-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              value={safeData.status || 'Verified'}
      ...
      <div className="bg-[#0b1528] border border-blue-900/60 p-6 rounded-2xl shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-2.5 shrink-0">
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="flex items-center space-x-1.5 px-4 py-2.5 bg-amber-500 hover:bg-amber-400 text-slate-950 rounded-xl text-xs font-bold transition-all shadow-md shadow-amber-500/20 disabled:opacity-50"
          >
            <Save className="w-4 h-4" />
            <span>{isSaving ? 'Saving File...' : 'Save Master Verification'}</span>
          </button>
        </div>
      </div>
